...
<div class="cookie-notifier" data-cookie-notifier="" id="js-cookie-note">
	<div class="cookie-notifier__info">
		<div class="cookie-notifier__title text text--small text--primary text--w-medium">
			Мы используем файлы cookies
		</div>
		<div class="cookie-notifier__text text text--tiny text--primary text--w-regular">
			Для улучшения работы сайта. Подробнее — в <a class="cookie-notifier_policy" href="/privacy-policy">Политике обработки персональных данных</a>. Продолжая пользоваться сайтом, Вы даёте согласие на использование файлов cookies.
		</div>
		<div class="cookie-notifier__excerpt text text--tiny text--primary text--w-regular">
	...
	<div class="cookie-notifier__btn">
		<button class="button button--primary js-cookie-accept">
